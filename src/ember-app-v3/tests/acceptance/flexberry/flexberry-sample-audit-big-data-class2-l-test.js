...
moduleForAcceptance('[AGAT] Acceptance | flexberry sample audit big data class2 l');

test('testing flexberry-sample-audit-big-data-class2-l', function(assert) {
  visit('/flexberry-sample-audit-big-data-class2-l');
