...
moduleForAcceptance('[AGAT] Acceptance | flexberry sample audit big data class1 l');

test('testing flexberry-sample-audit-big-data-class1-l', function(assert) {
  visit('/flexberry-sample-audit-big-data-class1-l');
