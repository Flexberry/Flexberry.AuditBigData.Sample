...
moduleForModel('flexberry-sample-audit-big-data-class1', 'Unit | Serializer | flexberry-sample-audit-big-data-class1', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-sample-audit-big-data-class1',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
