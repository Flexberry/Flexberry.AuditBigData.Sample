...
moduleForModel('flexberry-sample-audit-big-data-class3', 'Unit | Serializer | flexberry-sample-audit-big-data-class3', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-sample-audit-big-data-class3',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
