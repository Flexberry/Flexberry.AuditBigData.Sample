...
moduleForModel('flexberry-sample-audit-big-data-class4', 'Unit | Serializer | flexberry-sample-audit-big-data-class4', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-sample-audit-big-data-class4',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
